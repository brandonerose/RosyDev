...
# your_package_here <img src="inst/app/www/logo.png" align="right" height="150" />
...
## your_package_here Installation

your_package_here is designed to...

``` r
# install remotes package if you don't have it
# install.packages("remotes") 
remotes::install_github("brandonerose/your_package_here")
```

## your_package_here Example

your_package_here can be use like this...
...
The your_package_here package is at [github.com/brandonerose/your_package_here](https://github.com/brandonerose/your_package_here "your_package_here R package")
See instructions above. Install remotes and install your_package_here
